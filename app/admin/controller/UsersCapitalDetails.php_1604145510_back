...
class UsersCapitalDetails extends Base
{
    // 验证器
    protected $validate = 'UsersCapitalDetails';

    // 当前主表
    protected $tableName = 'users_capital_details';

    // 当前主模型
    protected $modelName = 'UsersCapitalDetails';
