...
class Error extends Base
{
    ...
    public function initialize()
    {
        ...
        // 当前表名称
        $model = Module::where('id', '=', $this->moduleId)->find();
        $this->tableName = $model->getData('table_name');

        View::assign('cat_model', $model);
